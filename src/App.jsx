...
const products = [
const products = [
  {id: 1, title: 'Minecraft', price: 1500, img: 'https://images.vsemayki.ru/get/0/1/3277/3277054/img_v2_1000.jpg'},
...
function App() {
  ...
  const s = {
    ...
    img: { width: '100%', height: '130px', objectFit: 'cover', borderRadius: '10px', marginBottom: '10px' },
    btn: { width: '100%', padding: '10px', marginTop: 'auto', border: 'none', borderRadius: '10px', background: 'var(--tg-theme-button-color)', color: 'var(--tg-theme-button-text-color)', fontWeight: 'bold' }
  };

  return (
    <div style={s.container}>
      <h2 style={{margin: '0 0 10px 0'}}>Магазин игр</h2>
      <div style={s.grid}>
        {products.map(item => (
